...
for i in range(max_iter):
    ...
    Placeholder_2["Feed_Flow"] = results_3[2] + Feed["Feed_Flow"] # Initial Feed + Membrane 1 Permeate + Membrane 3 Retentate flows
    for j in range(J):
        Placeholder_2["Feed_Composition"][j] = ( results_3[0][j] * results_3[2] + Feed["Feed_Composition"][j] * Feed["Feed_Flow"] ) / (Placeholder_2["Feed_Flow"]) #Component Mole Fractions
    ...
    Convergence_Composition = (Convergence_Composition2 + Convergence_Composition3) 
    ...
    Convergence_Flowrate = (Convergence_Flowrate2 + Convergence_Flowrate3) / 100
    ...
    if i > 0 and Convergence_Composition < tolerance and Convergence_Flowrate < tolerance:  
        ...
        print(f'Membrane 3 Feed Composition before iteration is {Placeholder_2["Feed_Composition"]} with flow {Placeholder_2["Feed_Flow"]:3e} mol/s')
        print(f'Membrane 3 Feed Composition after iteration is {Membrane_2["Feed_Composition"]} with flow {Membrane_2["Feed_Flow"]:3e} mol/s')        
        print(f'Component 1 Recovery in P is {results_4[1][0]*results_4[3]/(Feed["Feed_Composition"][0]*Feed["Feed_Flow"])*100:.4f}%')
        print(f'Component 1 Purity in P is {results_4[1][0]*100:.4f}%')
